...
def find_tx_by_request_id(
    ...
    for start in range(from_block, latest_block, MAX_BLOCK_SPAN):
        ...
        for log in logs:
            decoded = decode(["bytes32", "bytes"], log["data"])
            request_id, request_data = decoded

            ipfs_link = f"http://gateway.autonolas.tech/ipfs/f01701220{request_data.hex()}/metadata.json"
...
if __name__ == "__main__":
    ...
    contract_address = "0xB3C6319962484602b00d5587e965946890b82101"
    days = 1
